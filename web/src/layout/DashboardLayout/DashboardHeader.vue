...
<div class="w-full h-full flex items-center justify-between px-4">
    <div>
        <w-btn circle bgColor="bg-gray-100 dark:bg-gray-600" bgColorHover="hover:bg-gray-200" textColor="text-gray-700 dark:text-gray-200" v-on:click="setCollapsed()">
            <a href="#">
    ...
    <div class="flex space-x-3 items-center justify-between">
        <div>
            <w-btn circle @click="setRTL" bgColor="bg-gray-transparent" bgColorHover="hover:bg-gray-200" textColor="text-gray-500" v-on:click="setCollapsed()">

                <component :is="rtl?'IconTextAlignLeft':'IconTextAlignRight'" class="text-purple-700 dark:text-purple-400" height="24" width="24" @click="isLight = !isLight" />

            </w-btn>
        </div>
        <a href="#">
            <component :is="isLight?'icon-moon':'icon-sun'" class="text-purple-700 dark:text-purple-400" height="24" width="24" @click="isLight = !isLight" />
        </a>
    </div>
</div>
</template>
